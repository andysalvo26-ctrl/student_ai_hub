...
def main():
    ...
    index_path = BASE_DIR / "data/indexes/corpus_index_stable.json"
    chunks_jsonl_path = BASE_DIR / "data/chunks/chunks.jsonl"
    chunk_index_path = BASE_DIR / "data/indexes/chunk_index.json"
